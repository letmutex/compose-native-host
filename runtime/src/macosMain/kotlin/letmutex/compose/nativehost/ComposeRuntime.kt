...
class ComposeRuntime(
    ...
    private val bridge = MacOsComposeBridge(runtimeId)
    ...
    private val scope = ComposeNativeHostScopeImpl { name, payload ->
    ...
    fun handleExternalDragEntered(
        ...
        return NativeHostUiThread.shared.callOnUiThread {
            ...
            renderer.handleExternalDragEntered(
                ...
                positionInRoot = Offset(x = x.toFloat(), y = y.toFloat()),
                action = dragAndDropActionFromRaw(action),
    ...
    fun closeRuntime() {
        val rendererToClose: ComposeMetalRenderer?
    ...
    private fun ensureInitialized(): Boolean {
        ...
        synchronized(this) {
            ...
            renderer = createComposeMetalRenderer(
                hostBridge = bridge,
...
@OptIn(ExperimentalComposeUiApi::class)
private fun dragAndDropActionFromRaw(rawValue: Int): DragAndDropTransferAction? =
    when (rawValue) {
