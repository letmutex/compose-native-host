...
private fun shouldUseNativeHostClipboard(): Boolean {
    return letmutex.compose.nativehost.isComposeNativeHostAvailable() &&
        letmutex.compose.nativehost.isComposeNativeHostSharedLibraryRuntime()
}
...
private suspend fun writeNativeHostClipboardText(text: String): Boolean =
    writePlatformClipboardText(text)
