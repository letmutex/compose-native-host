...
bool HostJvm::PrepareRuntime(int64_t runtimeId, const std::string& mainClassName, bool profileEnabled) {
    ...
    WithAttachedEnv([&](JNIEnv* env) {
        ...
        // Call Kotlin App entry main function
        ...
        if (!appMainClass) {
            ...
            // Try fallback suffix HostedMainKt or MainKt
